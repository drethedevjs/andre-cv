...
let skillsData: Array<SkillsProps> = [
  ...
  { name: "Backend Development", proficient: true },
  { name: "Bootstrap", proficient: true },
  { name: "C#", proficient: true },
  { name: "Elasticsearch", proficient: true },
  { name: "Entity Framework", proficient: true },
  { name: "Git", proficient: true },
  { name: "JavaScript", proficient: true },
  { name: "Model View Controller (MVC)", proficient: true },
  { name: "ASP.NET MVC", proficient: true },
  { name: "Microsoft SQL Server", proficient: true },
