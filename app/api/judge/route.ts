  ...
  const response = await gem.models.generateContent({
    ...
    config: {
      systemInstruction: `You are filtering questions and responses by a user (potential employer) that is asking an \
        ...
        suggestions on how to improve their question or response. Be kind when responding and speak in the first \
        person as if you're responding as the engineer. If the user asks about contacting you, allow that to be a relevant question.`,
